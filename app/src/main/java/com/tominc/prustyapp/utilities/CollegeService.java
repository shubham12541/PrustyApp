...
public class CollegeService {
    private final String TAG = "CollegeService";
    ...
    public List<String> getColleges(String queryString){
        ...
        final int[] counter = {0};
        Log.d(TAG, "getColleges: Getting college names");
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                if(dataSnapshot.exists()){
                    ...
                    for(DataSnapshot college: dataSnapshot.getChildren()){
                        result.add((String) college.getValue());
                        Log.d(TAG, "onDataChange: Got Value: " + college.getValue());
                    }
                } else{
